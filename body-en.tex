...
operations. The first author of this paper, in his master's research,
composed a woodwind quintet based in contour theories operations, and
using the mentioned software (see section
...
The mentioned quintet is based on combinations of contour operations
associated with parameters such as pitch, tempo, density and
texture. This quintet is based on a six notes motive $\alpha$
...
rotation, interpollation---were the only one used in the piece.
