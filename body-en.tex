...
Contour represents a significant structural device in cited quintet
...
operations calculation and plotting. In the future the software will
also receive as input scores in the
Lilypond\footnote{\url{http://lilypond.org/}} format and will have a
graphical interface.
